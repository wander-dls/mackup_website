...
const Hero = () => (
  ...
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-16`}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of experts uses methodology to indentify
        the credit cards most likely to fit your needs.
        we examine annual percentage and rates, annual fees.
      </p>
    </div>

    <div className={`flex-1 flex ${styles.flexCenter} md:my-9 my-10 relative`}>
